class Consultation < ApplicationRecord
  ...
  validates :consult_focus, :consultfee, :consult_desc, :consult_demo, :consult_location, presence: true
  validates :consult_desc, length: { maximum: 1000, too_long: "%{count} characters is the maximum allowed. Please shorten your description!" }
