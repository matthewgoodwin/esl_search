class ConsultationsController < ApplicationController
  ...
  def show
    ...
    @consultation_review_star = @consultation.reviews.all.map{|x| [x.review_rating]}
  ...
  def consultation_params
    params.require(:consultation).permit(:consult_language, :consult_sec_lang, :consult_native_speaker, :consult_focus, :consult_period, :consult_dur, :consult_type, :consult_demo, :consultfee, :consult_title, :consult_desc, :consult_location, :matincluded, :consult_dow=>[])
  end
end
