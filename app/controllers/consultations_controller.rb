class ConsultationsController < ApplicationController
  skip_before_action :authenticate_user!, only: [:index, :show, :langs_tutors, :lang_tutor, :langs_locs, :lang_locs, :lang_loc,
  ...
  before_action :language_params, only: [:langs_tutors, :lang_tutor, :lang_locs, :lang_loc, :lang_types, :lang_type,:lang_period, :lang_periods, :langs_onlines, :lang_online, :lang_hourly,:lang_single, :lang_edus, :lang_edu, :lang_act, :lang_top_rated, :location]
  before_action :period_params, only: [:lang_period, :langs_periods]
  before_action :type_params, only: [:lang_type, :langs_types]
  skip_after_action :verify_authorized, only: [:langs_tutors, :lang_tutor, :langs_locs, :lang_locs, :lang_loc, :langs_types, :lang_types, :lang_type, :langs_periods, :lang_periods, :lang_period, :langs_onlines, :lang_online,
