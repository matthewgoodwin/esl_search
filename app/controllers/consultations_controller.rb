class ConsultationsController < ApplicationController
  ...
  def consultation_params
    params.require(:consultation).permit(:consult_language, :consult_focus, :consult_period, :consult_type, :consultfee, :consult_title, :consult_desc, :consult_location, :matincluded, :consult_freq=>[], :consult_dow=>[])
  end
end
